...
class AttemptsControllerTest < ActionController::TestCase
  ...
  test "should create attempt" do
    assert_difference('Attempt.count') do
      post :create, attempt: { number_of_attempts: @attempt.number_of_attempts, quiz_id: @attempt.quiz_id, student_id: @attempt.student_id }
    end
  ...
  test "should update attempt" do
    patch :update, id: @attempt, attempt: { number_of_attempts: @attempt.number_of_attempts, quiz_id: @attempt.quiz_id, student_id: @attempt.student_id }
    assert_redirected_to attempt_path(assigns(:attempt))
  end
